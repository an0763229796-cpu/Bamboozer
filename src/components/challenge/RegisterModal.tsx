        ...
        {step === 'form' ? (
          <div className="p-6 sm:p-8">
            <div className="flex items-center gap-2 text-xs font-mono text-[#00C076] mb-2">
              ...
              <span>GHI DANH THAM GIA MÙA 01</span>
            </div>
            <h3 className="text-xl sm:text-2xl font-bold tracking-tight mb-2">
              Bamboozer 14-Day Trading Challenge
            </h3>
            <p className="text-xs text-slate-400 mb-6">
              Đăng ký miễn phí để tranh giải <strong className="text-emerald-400">$700 Tiền Mặt + Gói Pro VIP</strong>. Kích hoạt quyền tham gia chính thức.
            </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  placeholder="UID 8-10 số (Binance / Bybit / OKX)"
                  value={exchangeUid}
          ...
          <div className="p-8 text-center space-y-5">
            ...
            <div>
              ...
              <p className="text-xs text-slate-300 max-w-sm mx-auto">
                Hệ thống đã ghi nhận thí sinh <strong className="text-emerald-400 font-mono">{username}</strong> vào bảng đấu Mùa 01 thành công.
              </p>
            </div>
            ...
            <div className="bg-[#05080e] p-4 rounded-xl border border-slate-800 text-left font-mono text-xs space-y-1.5">
              ...
              <div className="flex justify-between text-slate-400">
                ...
                <span className="text-white">Bamboozer 14-Day Challenge Mùa 01</span>
              </div>
              <div className="flex justify-between text-slate-400">
                <span>Quyền lợi:</span>
            ...
            <div className="space-y-2 pt-2">
              ...
              >
                <span>MỞ SÀN GIAO DỊCH ĐỂ KẾT NỐI</span>
